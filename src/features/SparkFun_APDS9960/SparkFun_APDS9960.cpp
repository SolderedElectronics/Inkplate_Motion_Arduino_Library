...
#ifdef LIBRARY_FEATURE_APDS9960_ENABLED
...
bool SparkFun_APDS9960::decodeGesture()
{
    ...
    if( (gesture_ud_count_ == -1) && (gesture_lr_count_ == 0) ) {
        gesture_motion_ = DIR_LEFT;     // Originally DIR_UP    
    } else if( (gesture_ud_count_ == 1) && (gesture_lr_count_ == 0) ) {
        gesture_motion_ = DIR_RIGHT;    // Originally DIR_DOWN
    } else if( (gesture_ud_count_ == 0) && (gesture_lr_count_ == 1) ) {
        gesture_motion_ = DIR_UP;       // Originally DIR_RIGHT
    } else if( (gesture_ud_count_ == 0) && (gesture_lr_count_ == -1) ) {
        gesture_motion_ = DIR_DOWN;     // Originally DIR_LEFT
