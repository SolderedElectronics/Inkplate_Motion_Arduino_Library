...
#ifdef LIBRARY_FEATURE_LSM6DS3_ENABLED
...
status_t LSM6DS3Core::beginCore(void)
{
  ...
  uint32_t spiPortSpeed = 5000000;
	...
	if(!(readCheck == 0x69 || readCheck == 0x6C))
	{
...
{
	int16_t output;
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTX_L_XL without minus sign at the return.
...
int16_t LSM6DS3::readRawAccelY( void )
{
	int16_t output;
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTY_L_XL without minus sign at the return.
...
float LSM6DS3::readFloatAccelY( void )
{
	...
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTZ_L_XL without minus sign at the return.
...
int16_t LSM6DS3::readRawGyroX( void )
{
	int16_t output;
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTX_L_G without minus sign at the return.
...
int16_t LSM6DS3::readRawGyroY( void )
{
	int16_t output;
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTY_L_G without minus sign at the return.
...
int16_t LSM6DS3::readRawGyroZ( void )
{
	int16_t output;
	// Modified to suit position of the LSM6DS3 on the Inkplate Motion board.
	// Originally LSM6DS3_ACC_GYRO_OUTZ_L_G without minus sign at the return.
