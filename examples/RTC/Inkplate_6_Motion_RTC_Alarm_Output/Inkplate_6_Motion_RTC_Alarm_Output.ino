/*
   This example shows how to use STM32H743 (Inkplate NextGen) internal RTC to make alarm
   event and send pulse on alarm event on PC13 pin. Hookup 330R resistor and an LED on
   PC13. When alarm triggers, LED will blink.
*/
