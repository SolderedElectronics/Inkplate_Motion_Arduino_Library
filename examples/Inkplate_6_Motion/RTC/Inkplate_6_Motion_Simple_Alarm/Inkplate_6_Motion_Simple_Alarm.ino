/*
   This example shows how to use STM32H743 (Inkplate NextGen) internal RTC
   to make alarm event
*/
...
void setup()
{
    ...
    // Initializer RTC library and set it to 24 hour format and reset RTC.
...
void loop()
{
    ...
    // First NULL is for PM/AM indicator (not used in 24 hour mode) and second is for
    // Daylight Saving (not used in this example).
